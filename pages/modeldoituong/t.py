...
classes = None
with open(r"modelobject\object_detection_classes_yolov4.txt", 'rt') as f:
...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet(
        r'modelobject\yolov4.weights', r"modelobject\yolov4.cfg")
